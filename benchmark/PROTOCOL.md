...
| **R4. Promote the discovery narrative.** | The "tile → chain_merge" pivot (8 % → 53 % paper-DMR recall) is described in the main text of paper.md as a methodological discovery, not buried in `idk_if_needed/`. | A reviewer reading the GitHub history will find this anyway; better to own it. |
