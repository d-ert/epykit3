...
survivor p-values + per-permutation null survivor pools and returns
...
from epykit.dmr import _region_count_ratio_fdr, _is_self_or_mirror_perm
...
def test_count_ratio_preserves_input_order():
    ...
    # same per-tile values as the sorted case, reordered to match input
